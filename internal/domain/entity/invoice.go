...
type InvoiceV2 struct {
	...
	InvoiceAmount      float64    `json:"invoice_amount"`        // Amount in yuan (元), persisted to DB
	InvoiceAmountCents int64      `json:"invoice_amount_cents"`  // Convenience: InvoiceAmount * 100, computed at runtime
	SellerName         string     `json:"seller_name"`
	SellerTaxID        string     `json:"seller_tax_id"`
	BuyerName          string     `json:"buyer_name"`
	BuyerTaxID         string     `json:"buyer_tax_id"`
